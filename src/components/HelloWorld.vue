      ...
      <div class="col-md-12 col-sm-12">
        ...
        <div id="forecasts" >
            ...
            <li id="singleForecast" v-for="day in infoForecast.data.forecast.forecastday">
              <div class="card">
                <img class="card-img-top" :src="day.day.condition.icon" alt="Weather Icon">
                <div class="card-body">
                  <p class="card-title" style="font-size:0.8em">{{day.date}}</p>
                  <p class="card-text" style="font-size:0.6em">{{day.day.condition.text}}</p>
...
export default {
  ...
  mounted () {
    this.urlForecast = 'http://api.apixu.com/v1/forecast.json?key=d669f00ce9574e84ad695232192603&q=Oslo&days=4';
        axios
    ...
    methods: {
      ...
      updateForecast(City){
        this.fore = City
        this.urlForecast = 'http://api.apixu.com/v1/forecast.json?key=d669f00ce9574e84ad695232192603&q=' + this.fore + '&days=4';
        axios
          .get(this.urlForecast)
          .then(response => (this.infoForecast = response))
